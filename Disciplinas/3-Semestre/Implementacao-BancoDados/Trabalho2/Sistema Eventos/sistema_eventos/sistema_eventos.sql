...
-- Criação de Papéis
--  >ADM          (cria usuários, eventos, opera tudo)
--  >Organizador  (cria e edita eventos, consulta eventos e insere arquivos)
--  >Palestrante  (insere palestra e edita palestra)
--  >Participante (consulta eventos, consulta palestra, inscreve-se em eventos, inscreve-se palestras)
