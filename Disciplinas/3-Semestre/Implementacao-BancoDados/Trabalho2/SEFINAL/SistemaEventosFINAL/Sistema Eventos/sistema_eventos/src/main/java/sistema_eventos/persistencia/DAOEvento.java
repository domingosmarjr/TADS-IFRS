...
public class DAOEvento {
    ...
    public int inserirEventoPrivado(EventoPrivado ep) throws SQLException {
        String sqlEvento = "INSERT INTO evento_privado (nome, local, data_inicio, hora_inicio, data_fim, hora_fim, detalhes, imagem_banner, organizador_id, senha_acesso, lista_convidados) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) RETURNING id";
